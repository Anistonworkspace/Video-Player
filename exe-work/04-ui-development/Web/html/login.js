...
$(function(){
    ...
    /* language selector removed for AnistonCam rebrand */
    ...
    function onLoginBtnClk(c) {
        ...
        function loginSuccess() {
            ...
            if(WebCms.web.visiblePlayBackMenu ){
    ...
    gDevice.GetPreLoginInfo(function(a){
        ...
        gOemInfo.setCurLang(a.Language);
        lan("login");
        GetRandomFunc(function(a){
            ...
            getPluginVer(url, req).done(function(a){
                if(compareVersion(version_web, a.Version)){
                    $("#DownloadDiv").css("display", "");
